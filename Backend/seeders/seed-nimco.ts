...
const products: ProductInput[] = [
  { name: "Bareeq Sev (250gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 960 },
  { name: "Bareeq Gathiya (250gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 960 },
  { name: "Bhel Poori (250gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 960 },
  { name: "Boondian Bareeq (250gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 1200 },
  { name: "Boondian (250gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 1200 },
  { name: "Chat Papri (80gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 1250 },
  { name: "Chewara (250gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 960 },
  { name: "Daal Mooth (250gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 960 },
  { name: "Manda Papri (150gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 280 },
  { name: "Masalah Gathiya (300gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 960 },
  { name: "Mix Nimco (250gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 960 },
  { name: "Daal Moong (250 gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 1120 },
  { name: "Sweet Chewara (250gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 960 },
  { name: "Thick Gathiya (250gms)", unit: "Pcs", category: "Nimco", purchase_rate: 0, selling_price: 960 },
];
...
async function seedNimco() {
  console.log('🌱 Starting Nimco seeder (Fast Mode)...\n');
  ...
  const [category, units, lastProduct, unknownTax, unknownSupplier, unknownBrand] = await Promise.all([
    getOrCreateEntry('category', 'Nimco', 'CAT'),
    Promise.all([
